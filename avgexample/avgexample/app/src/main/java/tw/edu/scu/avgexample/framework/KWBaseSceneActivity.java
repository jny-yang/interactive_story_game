...
public class KWBaseSceneActivity extends KWBaseFullScreenActivity {
    ...
    private void initializeEventPictureLayer() {
        ...
        //建立放置於中間的事件圖片
        FrameLayout.LayoutParams pictureImageViewParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT, Gravity.CENTER);
        //pictureImageViewParams.setMargins(20,20,20,20);

        this.pictureImageView = new ImageView(this);
        this.pictureImageView.setLayoutParams(pictureImageViewParams);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (event.getKeyCode() == KeyEvent.KEYCODE_SPACE && event.getAction()==KeyEvent.ACTION_UP){
            this.eventManager.messageDialog.triggerDialogClick();
            return false;
